...
const SvgVirusSanitizerSpray = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="m24.86 10.832-1.6 1.6-4.242-4.243 1.6-1.6a2 2 0 0 1 2.828 0l1.414 1.415a2 2 0 0 1 0 2.828ZM14.374 9.418h3.044l4.613 4.613v3.044a2 2 0 0 1-.586 1.414l-5.778 5.778a4 4 0 0 1-5.657 0L7.182 21.44a4 4 0 0 1 0-5.657l5.778-5.778a2 2 0 0 1 1.414-.586ZM31.385 11.75l.118-.12.458.468-.576-.348Z" />
