...
const SvgFactoryWorker = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M15.319 13.215c.683-2.152 2.41-3.932 4.681-4.907V11a1 1 0 1 0 2 0V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 1 0 2 0V8.308c2.304.989 4.047 2.805 4.71 4.999-.257.208-.686.46-1.355.704-1.492.544-3.995.989-7.881.989-2.799 0-5.048-.436-6.566-.99-.732-.267-1.258-.549-1.589-.795Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
