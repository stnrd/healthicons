  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M28.087 29.134a2.397 2.397 0 0 0 4.569-1.014h.003a4.3 4.3 0 0 0 2.286-.653 2.395 2.395 0 0 0 3.612.537c.763 3.073 1.512 5.314 1.976 6.582.224.616-.166 1.302-.816 1.38-3.977.479-8.579.49-12.544-.008a.984.984 0 0 1-.801-1.29c.42-1.287 1.124-3.481 1.715-5.534ZM28 38.014V40.5a1.5 1.5 0 0 0 2.948.39l.674-2.496a39.463 39.463 0 0 1-3.622-.38Zm7.376.372.676 2.505A1.5 1.5 0 0 0 39 40.5V38a41.55 41.55 0 0 1-3.624.386ZM22.853 29.149a1.5 1.5 0 0 0-.706-2.916c-2.86.692-5.018 1.003-7.142.995-2.127-.008-4.29-.336-7.168-.999a1.5 1.5 0 1 0-.674 2.924c1.706.392 3.223.685 4.668.865v4.334a1.509 1.509 0 0 0-.022.127l-.733 5.834a1.5 1.5 0 0 0 2.962.465l1.093-5.794 1.092 5.794a1.5 1.5 0 0 0 2.963-.465l-.734-5.834a1.525 1.525 0 0 0-.022-.127v-4.35c1.37-.178 2.812-.463 4.423-.853Z"
        fill="#333"
      />
