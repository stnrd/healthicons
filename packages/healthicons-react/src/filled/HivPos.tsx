...
const SvgHivPos = (
  ...
  return (
    ...
    >
      ...
      />
      <path d="M31 19a1 1 0 1 0 0 2h2v2a1 1 0 1 0 2 0v-2h2a1 1 0 1 0 0-2h-2v-2a1 1 0 1 0-2 0v2h-2ZM16.567 29.728l4.889 6.204.004.006 1.16 1.48-4.255 5.425a2 2 0 0 1-2.781.36l-4.379-3.317a2 2 0 0 1-.368-2.826l5.73-7.332Z" />
    </svg>
  );
};
