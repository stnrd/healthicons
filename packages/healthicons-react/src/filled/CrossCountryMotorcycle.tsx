...
const SvgCrossCountryMotorcycle = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="m28.053 23.894 1-2a2 2 0 0 0 0-1.788l-1-2A2 2 0 0 0 26.263 17h-3.28a8 8 0 0 0-2.563.422l-3.145 1.063a1 1 0 0 0-.494 1.528l3.253 4.567a1 1 0 0 0 .815.42h5.415a2 2 0 0 0 1.789-1.106ZM5 19h8.096a1 1 0 0 1 .788.383l2.882 3.68a.5.5 0 0 1-.449.806L4.89 22.599a1 1 0 0 1-.89-.994V20a1 1 0 0 1 1-1ZM28 27h-6a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-4ZM33.309 15h3.93a.5.5 0 0 1 .41.213l2.8 4a.5.5 0 0 1-.41.787h-4.73a.5.5 0 0 1-.447-.276l-2-4a.5.5 0 0 1 .447-.724Z"
        fill="#333"
      />
    </svg>
  );
