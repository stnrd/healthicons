...
const SvgCommunityMeeting = (
  ...
  return (
    ...
    >
      ...
      />
      <path d="M15.504 28.002a2.5 2.5 0 1 0-.004-5 2.5 2.5 0 0 0 .004 5ZM8.504 32.002a2.5 2.5 0 1 0-.004-5 2.5 2.5 0 0 0 .004 5ZM28.002 29.5a2.5 2.5 0 1 1-5 .004 2.5 2.5 0 0 1 5-.004ZM15 29a2 2 0 0 1 2 2v2h2a2 2 0 1 1 0 4h-4a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2ZM10 35a2 2 0 1 0-4 0v5a2 2 0 0 0 2 2h4a2 2 0 1 0 0-4h-2v-3ZM26 33a2 2 0 0 0-2 2v3h-2a2 2 0 1 0 0 4h4a2 2 0 0 0 2-2v-5a2 2 0 0 0-2-2Z" />
    </svg>
  );
};
