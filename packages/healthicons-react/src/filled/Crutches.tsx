...
const SvgCrutches = (
  ...
  return (
    ...
    >
      ...
      />
      <path d="M22.302 41.966c.134-.632 1.038-.973 1.684-.973.659 0 1.568.34 1.707.983l.15.686c.093.432-.108.877-.52 1.037-.388.151-.886.3-1.337.3-.422 0-.914-.15-1.303-.3-.414-.162-.62-.608-.527-1.043l.146-.69Z" />
    </svg>
  );
};
