...
const SvgCriticalCare = (
  ...
  return (
    ...
    >
      ...
      />
      <path d="M13.846 21.679h5.658l3.403-5.985 2.127 7.363 2.602-3.31h5.513a1 1 0 0 1 1.005.994 1 1 0 0 1-1.005.993h-4.53l-4.43 5.633-1.891-6.548-1.62 2.847h-6.832V21.68Z" />
    </svg>
  );
};
