...
const SvgNegativeBaby0306M = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#negative_baby_0306m_svg__a)">
        <path
          fill="#333"
          fillRule="evenodd"
      ...
      <defs>
        <clipPath id="negative_baby_0306m_svg__a">
...
const ForwardRef = forwardRef(SvgNegativeBaby0306M);
