...
const SvgNegativeSynergistInsecticideBioassays = (
  ...
  return (
    ...
    >
      <path
        fill="#333"
        d="M14 10a1.333 1.333 0 1 0 0-2.667A1.333 1.333 0 0 0 14 10Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
      ...
      <path
        fill="#333"
        d="M35 12.156c0-.705-.384-1.352-1-1.69v-.695h6v.696c-.616.337-1 .984-1 1.689v7.688c0 .705.384 1.352 1 1.69v.695h-6v-.696c.616-.337 1-.984 1-1.689v-7.688Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgNegativeSynergistInsecticideBioassays);
