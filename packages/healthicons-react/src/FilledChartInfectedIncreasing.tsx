...
const SvgFilledChartInfectedIncreasing = (
  ...
  return (
    ...
    >
      <path
        fill="#333"
        d="M20.5 20.6a5.1 5.1 0 1 0 0-10.2 5.1 5.1 0 0 0 0 10.2Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
      ...
      <path
        fill="#333"
        fillRule="evenodd"
        d="m16.393 12.807-2.55-2.55 1.414-1.414 2.55 2.55-1.414 1.414Zm21.787 1.21a1 1 0 0 1 .803 1.164c-1.457 7.928-4.976 13.426-9.935 16.921C24.112 35.582 17.858 37 11.052 37H7a1 1 0 1 1 0-2h4.052c6.552 0 12.354-1.368 16.843-4.532 4.467-3.148 7.743-8.15 9.122-15.649a1 1 0 0 1 1.164-.803Z"
        clipRule="evenodd"
      />
      <path
        fill="#333"
...
const ForwardRef = forwardRef(SvgFilledChartInfectedIncreasing);
