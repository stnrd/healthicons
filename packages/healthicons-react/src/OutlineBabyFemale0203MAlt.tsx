...
const SvgOutlineBabyFemale0203MAlt = (
  ...
  return (
    ...
    >
      <path
        fill="#333"
        fillRule="evenodd"
        d="M13 17.917A6.002 6.002 0 0 0 12 6a6 6 0 0 0-1 11.917V20H9a1 1 0 1 0 0 2h2v3a1 1 0 1 0 2 0v-3h2a1 1 0 1 0 0-2h-2v-2.083ZM16 12a4 4 0 1 1-8 0 4 4 0 0 1 8 0Zm17 6a6 6 0 1 0 0-12 6 6 0 0 0 0 12Zm4-6a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z"
        clipRule="evenodd"
      />
      <path
        fill="#333"
...
const ForwardRef = forwardRef(SvgOutlineBabyFemale0203MAlt);
