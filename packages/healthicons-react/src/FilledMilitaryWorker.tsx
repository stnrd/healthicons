...
const SvgFilledMilitaryWorker = (
  ...
  return (
    ...
    >
      ...
      <path
        fill="#333"
        d="m35 24 5-2.857V9h2v23l-7-3v-5Zm.726 7.728L32.644 42H42v-5.5c0-2.004-2.663-3.642-6.274-4.772Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledMilitaryWorker);
