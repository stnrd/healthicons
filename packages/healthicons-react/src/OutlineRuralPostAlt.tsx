  ...
  return (
    ...
    >
      ...
      <path
        fill="#333"
        fillRule="evenodd"
        d="M24 8.548a1 1 0 0 1 1 1v2.5h2.5a1 1 0 1 1 0 2H25v2.5a1 1 0 0 1-2 0v-2.5h-2.5a1 1 0 0 1 0-2H23v-2.5a1 1 0 0 1 1-1ZM20 31h-5v9h5v-9Zm-7-2v13h9V29h-9Zm22 2h-8v4h8v-4Zm-10-2v8h12v-8H25Z"
        clipRule="evenodd"
      />
    </svg>
  );
};
const ForwardRef = forwardRef(SvgOutlineRuralPostAlt);
