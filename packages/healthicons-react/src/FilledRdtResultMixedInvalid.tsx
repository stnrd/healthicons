...
const SvgFilledRdtResultMixedInvalid = (
  ...
  return (
    ...
    >
      <path
        fill="#333"
        d="M10.85 11.105c.238-.105.495-.131.743-.079.248.053.485.185.677.39a1 1 0 0 0 1.46-1.368 3.301 3.301 0 0 0-1.722-.978 3.207 3.207 0 0 0-1.966.206 3.383 3.383 0 0 0-1.495 1.304A3.62 3.62 0 0 0 8 12.5c0 .678.188 1.346.547 1.92.36.574.877 1.031 1.495 1.304a3.208 3.208 0 0 0 1.966.206 3.3 3.3 0 0 0 1.722-.978 1 1 0 1 0-1.46-1.368c-.192.205-.43.337-.677.39a1.207 1.207 0 0 1-.742-.079 1.384 1.384 0 0 1-.609-.537A1.62 1.62 0 0 1 10 12.5c0-.31.087-.61.242-.858.156-.248.37-.432.609-.537ZM22 23h-2v2h2v-2Zm-11 0h7v2h-7a1 1 0 1 1 0-2Zm13 2h2a1 1 0 1 0 0-2h-2v2Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledRdtResultMixedInvalid);
