...
const SvgNegativeRdtResultPositive = (
  ...
  return (
    ...
    >
      <path
        fill="#333"
        d="M18 40a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm-1.5-7.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgNegativeRdtResultPositive);
