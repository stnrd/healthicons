  ...
  return (
    ...
    >
      ...
      <path
        fill="#333"
        fillRule="evenodd"
        d="M19.862 38.5c.273-.34.438-.77.438-1.25 0-1.172-.99-2.05-2.12-2.05h-.86c-1.13 0-2.12.878-2.12 2.05 0 .48.165.91.438 1.25a1.98 1.98 0 0 0-.438 1.25c0 1.172.99 2.05 2.12 2.05h.86c1.13 0 2.12-.878 2.12-2.05 0-.48-.165-.91-.438-1.25Zm-2.542-1.7c-.329 0-.52.242-.52.45 0 .208.191.45.52.45h.86c.329 0 .52-.242.52-.45 0-.208-.191-.45-.52-.45h-.86Zm1.38 2.95c0-.208-.191-.45-.52-.45h-.86c-.329 0-.52.242-.52.45 0 .208.191.45.52.45h.86c.329 0 .52-.242.52-.45Z"
        clipRule="evenodd"
      />
      <path
        fill="#333"
        d="M32.048 36.98c.12.1.152.198.152.27 0 .076-.038.186-.178.29a1.044 1.044 0 0 0-.024.019l-3.5 2.818A.8.8 0 0 0 29 41.8h4a.8.8 0 0 0 0-1.6h-1.73l1.722-1.387c.466-.353.808-.905.808-1.563 0-1.263-1.172-2.05-2.3-2.05h-1c-.915 0-1.798.489-2.151 1.321a.8.8 0 1 0 1.473.625c.059-.14.287-.346.678-.346h1a.86.86 0 0 1 .548.18ZM22 38.2a.8.8 0 0 0 0 1.6h1a.8.8 0 0 0 0-1.6h-1Zm12.942-18.39a3.819 3.819 0 1 1-6.763-3.548 3.819 3.819 0 0 1 6.763 3.547Z"
      />
    </svg>
  );
};
const ForwardRef = forwardRef(SvgFilledPregnant0812W);
