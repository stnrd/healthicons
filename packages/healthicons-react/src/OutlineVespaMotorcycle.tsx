...
const SvgOutlineVespaMotorcycle = (
  ...
  return (
    ...
    >
      ...
      <path
        fill="#333"
        fillRule="evenodd"
        d="M32 33H20v-2h12v2Zm-2-5h-9v-2h9v2Z"
        clipRule="evenodd"
      />
    </svg>
  );
};
const ForwardRef = forwardRef(SvgOutlineVespaMotorcycle);
