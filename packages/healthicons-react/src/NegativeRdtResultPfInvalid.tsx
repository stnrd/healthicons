...
const SvgNegativeRdtResultPfInvalid = (
  ...
  return (
    ...
    >
      <path
        fill="#333"
        d="M40 24a2 2 0 1 0-4 0 2 2 0 0 0 4 0Zm-7.5 1.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
      ...
      <path
        fill="#333"
        d="M17 34.5a.5.5 0 0 1-.5.5H15v-1h1.5a.5.5 0 0 1 .5.5ZM30.5 11a.5.5 0 0 1 0 1H29v-1h1.5Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgNegativeRdtResultPfInvalid);
