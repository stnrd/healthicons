...
const SvgOutlineBasicMotorcycle = (
  ...
  return (
    ...
    >
      ...
      <path
        fill="#333"
        fillRule="evenodd"
        d="M16.552 18.28a1 1 0 0 0-.695-.28H7a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h13a1 1 0 0 0 .695-1.72l-4.143-4ZM15.453 20l2.072 2H8v-2h7.453Zm23.332-6.373-7.644 2.94.718 1.866 5.356-2.06.571 3.428-5.134-.79-.304 1.977 7.866 1.21-1.43-8.571ZM22.626 31.986l-2.5-4.5 1.748-.972 2.5 4.5-1.748.972Z"
        clipRule="evenodd"
      />
      <path
        fill="#333"
...
const ForwardRef = forwardRef(SvgOutlineBasicMotorcycle);
