...
const SvgFilledVespaMotorcycle = (
  ...
  return (
    ...
    >
      ...
      <path
        ...
        clipRule="evenodd"
      />
      <path fill="#333" d="M9 21a3 3 0 0 1 3-3h9a3 3 0 0 1 3 3v1H9v-1Z" />
      <path
        fill="#333"
        fillRule="evenodd"
      ...
      <path
        fill="#333"
        fillRule="evenodd"
        d="M21 26h-6.914c-4.007 0-6.982 2.282-7.836 5h14.639a.45.45 0 0 0 .111-.013V26Zm-6.914-2C8.516 24 4 27.85 4 32.6c0 .22.21.4.47.4h16.419C22.055 33 23 32.194 23 31.2v-6.48c0-.398-.378-.72-.844-.72h-8.07Zm16.719-5.437L29 33h3.5l2.5-4.329V19h-2.5a3.484 3.484 0 0 1-1.695-.437Z"
        clipRule="evenodd"
      />
      <path
        fill="#333"
...
const ForwardRef = forwardRef(SvgFilledVespaMotorcycle);
