...
const SvgNegativeMoneyBag = (
  ...
  return (
    ...
    >
      <path
        fill="#333"
        d="M14.696 9.561c.924.291 1.904.545 2.9.729 2.159.398 4.333.457 6.193-.08 2.364-.685 4.845-1.239 7.17-1.567-1.984-.653-4.383-1.17-6.92-1.17-3.662 0-7.062 1.075-9.343 2.088Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
