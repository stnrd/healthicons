...
const SvgFilledIScheduleSchoolDateTime = (
  ...
  return (
    ...
    >
      ...
      <path
        fill="#333"
        d="M12 7a1 1 0 1 1 2 0v4a1 1 0 1 1-2 0V7Zm14 0a1 1 0 1 1 2 0v4a1 1 0 1 1-2 0V7Z"
      />
    </svg>
  );
};
const ForwardRef = forwardRef(SvgFilledIScheduleSchoolDateTime);
