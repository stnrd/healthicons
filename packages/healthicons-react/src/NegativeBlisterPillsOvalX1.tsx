...
const SvgNegativeBlisterPillsOvalX1 = (
  ...
  return (
    ...
    >
      ...
      <path
        fill="#333"
        d="M24.243 11.414a2 2 0 0 1 2.828 2.829l-2.828 2.828a2 2 0 0 1-2.829-2.828l2.829-2.829Z"
      />
    </svg>
  );
};
const ForwardRef = forwardRef(SvgNegativeBlisterPillsOvalX1);
