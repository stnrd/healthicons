...
const SvgKidneys = (
  ...
  return (
    ...
    >
      ...
      />
      <path d="m28.618 22.78.07.997h.016s-.01 0-.025.003a1.551 1.551 0 0 0-.616.258c-.29.206-.716.664-.716 1.82v14.467h-2V25.857c0-1.766.71-2.847 1.555-3.45a3.552 3.552 0 0 1 1.46-.603 2.47 2.47 0 0 1 .16-.02l.016-.002H28.548s.002 0 .07.997ZM19.242 22.78c-.068.997-.07.997-.07.997h-.015s.01 0 .024.003a1.553 1.553 0 0 1 .617.258c.29.206.716.664.716 1.82v14.467h2V25.857c0-1.766-.71-2.847-1.556-3.45a3.55 3.55 0 0 0-1.46-.603 2.472 2.472 0 0 0-.16-.02l-.015-.002H19.312l-.07.997Z" />
    </svg>
  );
};
