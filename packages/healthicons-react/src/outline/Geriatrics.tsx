...
const SvgGeriatrics = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M28.646 26.497a2.5 2.5 0 0 0-2.5 2.5h2a.5.5 0 0 1 .5-.5h.085c.323 0 .584.262.584.584v7.975a1 1 0 1 0 2 0V29.08a2.584 2.584 0 0 0-2.584-2.584h-.085Z" />
