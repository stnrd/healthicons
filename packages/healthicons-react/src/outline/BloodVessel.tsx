...
const SvgBloodVessel = (
  ...
  return (
    ...
    >
      ...
      />
      <path d="M25.227 12.85a1 1 0 1 1-1.7 1.055 1 1 0 0 1 1.7-1.055ZM23.227 21.85a1 1 0 1 1-1.7 1.055 1 1 0 0 1 1.7-1.056ZM24.227 28.85a1 1 0 1 1-1.7 1.055 1 1 0 0 1 1.7-1.056ZM23.227 37.85a1 1 0 1 1-1.7 1.055 1 1 0 0 1 1.7-1.056ZM23.227 8.85a1 1 0 1 1-1.7 1.055 1 1 0 0 1 1.7-1.055Z" />
    </svg>
  );
};
