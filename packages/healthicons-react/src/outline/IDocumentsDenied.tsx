...
const SvgIDocumentsDenied = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M22.707 20.293a1 1 0 0 0-1.414 1.414L24.586 25l-3.293 3.293a1 1 0 0 0 1.414 1.414L26 26.414l3.293 3.293a1 1 0 0 0 1.414-1.414L27.414 25l3.293-3.293a1 1 0 0 0-1.414-1.414L26 23.586l-3.293-3.293Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
