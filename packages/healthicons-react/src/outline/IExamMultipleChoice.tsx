...
const SvgIExamMultipleChoice = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M20 15a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2h-8a1 1 0 0 1-1-1ZM21 18a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2h-8ZM20 28a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2h-8a1 1 0 0 1-1-1ZM21 31a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2h-8Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
