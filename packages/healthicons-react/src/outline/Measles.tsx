...
const SvgMeasles = (
  ...
  return (
    ...
    >
      ...
      />
      <path d="M14.221 16.372a1 1 0 0 1 1.309-.22l4 2.5a1 1 0 0 1 0 1.696l-4 2.5a1 1 0 0 1-1.219-1.573c.373-.354.852-.72 1.244-1.02.174-.133.331-.253.454-.352.194-.158.328-.281.416-.38a4.362 4.362 0 0 0-.454-.409c-.106-.086-.23-.183-.367-.289-.41-.319-.92-.716-1.32-1.127a1 1 0 0 1-.063-1.326ZM32.47 16.152a1 1 0 0 1 1.246 1.546c-.4.41-.91.808-1.32 1.127-.136.106-.261.203-.367.29-.21.17-.356.302-.454.409.088.098.223.221.416.378.123.1.28.22.454.353.392.3.871.666 1.244 1.02a1 1 0 0 1-1.219 1.573l-4-2.5a1 1 0 0 1 0-1.696l4-2.5ZM26 12.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM38 27.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
