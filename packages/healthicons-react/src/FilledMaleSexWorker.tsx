...
const SvgFilledMaleSexWorker = (
  ...
  return (
    ...
    >
      <path
        fill="#333"
        d="M14.5 13a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm5.149 7c.05.352.093.729.132 1.122.218 2.245.219 4.679.219 5.378a1.5 1.5 0 0 0 3 0v-.007c0-.707 0-3.264-.233-5.662-.116-1.19-.297-2.43-.597-3.406-.148-.479-.355-1.002-.671-1.436-.317-.434-.909-.989-1.81-.989H9.31c-.901 0-1.493.555-1.81.99-.316.433-.523.956-.67 1.435-.3.976-.482 2.217-.598 3.406C6 23.229 6 25.786 6 26.493v.007a1.5 1.5 0 0 0 3 0c0-.7 0-3.133.22-5.378.038-.393.082-.77.131-1.122H10v20.5a1.5 1.5 0 0 0 2.995.12l.85-10.62h1.31l.85 10.62A1.5 1.5 0 0 0 19 40.5V20h.649Z"
      />
      <path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledMaleSexWorker);
