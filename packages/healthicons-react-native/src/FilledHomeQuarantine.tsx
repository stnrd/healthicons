...
const SvgFilledHomeQuarantine = (
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path fill="#333" d="M24 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
      <Path
        fill="#333"
        fillRule="evenodd"
      ...
      <Path
        fill="#333"
        d="m26.4 41 1.2-6.857H30v-3.429a5.579 5.579 0 0 0-1.757-4.04A6.155 6.155 0 0 0 24 25a6.155 6.155 0 0 0-4.243 1.674A5.579 5.579 0 0 0 18 30.714v3.429h2.4L21.6 41h4.8Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledHomeQuarantine);
