...
const SvgOutlinePpeGloves = (
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="M10 14h2v2h-2v-2Zm0 2v13a6.999 6.999 0 0 0 3.81 6.233L13.246 42h2.008l.608-7.307a1 1 0 0 0-.64-1.018A5.002 5.002 0 0 1 12 29V16h-2Z"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgOutlinePpeGloves);
