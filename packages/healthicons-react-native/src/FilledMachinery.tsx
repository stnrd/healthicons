...
const SvgFilledMachinery = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        d="M11.988 8.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm2 0a4.48 4.48 0 0 1-.897 2.696c2.631.852 5.27 1.912 7.01 3.802a.26.26 0 0 0 .374.011 14.05 14.05 0 0 1 2.745-2.099.249.249 0 0 0 .065-.378c-2.35-2.672-5.77-3.82-9.341-4.665.029.207.044.418.044.633Zm-3.268 4.33c-.392.11-.805.17-1.232.17-.894 0-1.727-.26-2.427-.71l-.976 11.162-.082 2.34a4 4 0 0 0 3.524 4.112l.181.022a4 4 0 0 0 3.937-1.973l2.196-3.806a.25.25 0 0 0-.275-.368l-1.774.43a.251.251 0 0 1-.076.008l-2.666-.174-1.73-.206a.25.25 0 0 1-.218-.285l1.617-10.723Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledMachinery);
