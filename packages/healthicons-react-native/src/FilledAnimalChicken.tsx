  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M24.2 40c4.056 0 7.75-1.524 10.533-4.025A13.865 13.865 0 0 1 29.478 37C22.071 37 16 31.216 16 24a1 1 0 0 1 2 0c0 6.039 5.102 11 11.478 11 3.525 0 6.67-1.521 8.772-3.905a.971.971 0 0 1 .22-.187c.5-1.09.877-2.248 1.113-3.455.369-1.892.914-3.784 2.078-5.32.483-.637-.06-1.536-.848-1.406L27.698 22.89a5 5 0 0 1-5.2-2.533l-4.564-8.34a3.88 3.88 0 0 0-7.159 2.835l.348 1.343a8.256 8.256 0 0 1-.017 4.205l-.761 2.842c-.882 3.293-1.135 6.912.75 9.753A15.695 15.695 0 0 0 24.201 40ZM14 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
...
const ForwardRef = forwardRef(SvgFilledAnimalChicken);
