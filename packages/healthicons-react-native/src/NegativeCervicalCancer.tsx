...
const SvgNegativeCervicalCancer = (
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="m31.88 24.173-7.023 7.373V42h-1.714V31.546l-7.022-7.373 1.212-1.273 6.667 7 6.667-7 1.212 1.273Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgNegativeCervicalCancer);
