...
const SvgFilledFever = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="M15.812 10.526c-.36-.701-1.263-.701-1.624 0l-4.061 7.895c-.36.702.09 1.579.812 1.579H14v9h2v-9h3.06c.723 0 1.174-.877.813-1.579l-4.06-7.895Z"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgFilledFever);
