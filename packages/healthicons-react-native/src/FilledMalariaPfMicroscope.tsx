...
const SvgFilledMalariaPfMicroscope = (
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        d="M20.003 14.752a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm-3.48.386a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Zm2.067 2.02a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Zm6.968 12.041a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm3.319-1.095a.453.453 0 1 1-.906 0 .453.453 0 0 1 .906 0ZM27.093 14.16a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm3.4.7a.7.7 0 1 1-1.4 0 .7.7 0 0 1 1.4 0ZM15.059 30.648a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm.629-3.213a.453.453 0 1 1-.907 0 .453.453 0 0 1 .906 0Zm2.044 2.727a.7.7 0 1 0 0-1.4.7.7 0 0 0 0 1.4Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledMalariaPfMicroscope);
