...
const SvgFilledChartInfectedDecreasing = (
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        d="M32.5 20.6a5.1 5.1 0 1 0 0-10.2 5.1 5.1 0 0 0 0 10.2Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M31.5 11.25v-3.4h2v3.4h-2Zm5.393-3.257a1 1 0 0 1 1.414 0l1.7 1.7a1 1 0 0 1-1.414 1.414l-1.7-1.7a1 1 0 0 1 0-1.414Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M36.6 15.5a1 1 0 0 1 1-1H41a1 1 0 1 1 0 2h-3.4a1 1 0 0 1-1-1Zm4.257 4.393a1 1 0 0 1 0 1.414l-1.7 1.7a1 1 0 0 1-1.414-1.414l1.7-1.7a1 1 0 0 1 1.414 0Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M32.5 19.6a1 1 0 0 1 1 1V24a1 1 0 1 1-2 0v-3.4a1 1 0 0 1 1-1Zm-7.507.293a1 1 0 0 1 1.414 0l1.7 1.7a1 1 0 0 1-1.414 1.414l-1.7-1.7a1 1 0 0 1 0-1.414Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M23 15.5a1 1 0 0 1 1-1h3.4a1 1 0 1 1 0 2H24a1 1 0 0 1-1-1Zm5.107-7.507a1 1 0 0 1 0 1.414l-1.7 1.7a1 1 0 0 1-1.414-1.414l1.7-1.7a1 1 0 0 1 1.414 0Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
...
const ForwardRef = forwardRef(SvgFilledChartInfectedDecreasing);
