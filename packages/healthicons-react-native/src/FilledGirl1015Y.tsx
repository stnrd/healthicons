...
const SvgFilledGirl1015Y = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        ...
        clipRule="evenodd"
      />
      <Path fill="#333" d="M28.5 10.5a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Z" />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgFilledGirl1015Y);
