...
const SvgFilledPwid = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        ...
        clipRule="evenodd"
      />
      <Path fill="#333" d="m4 11 10.375 11.759-7.705 8.11L4 29V11Z" />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgFilledPwid);
