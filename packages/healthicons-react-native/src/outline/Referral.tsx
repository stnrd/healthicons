  ...
  return (
    ...
    >
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M34 26a2 2 0 1 0 0 4 2 2 0 1 0 0-4Zm-4 2a4 4 0 0 1 4-4 4 4 0 0 1 4 4 4 4 0 0 1-4 4 4 4 0 0 1-4-4ZM28.294 36.867c-.283.285-.294.441-.294.497V40h12v-2.636c0-.056-.01-.212-.294-.497-.3-.303-.805-.634-1.506-.94C36.788 35.308 35.06 35 34 35s-2.788.31-4.2.926c-.701.306-1.205.638-1.506.941ZM34 33c-2.67 0-8 1.462-8 4.364V42h16v-4.636C42 34.462 36.67 33 34 33Z"
        fill="#333"
      />
      <Path
        fillRule="evenodd"
