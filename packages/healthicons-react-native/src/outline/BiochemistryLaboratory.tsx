...
const SvgBiochemistryLaboratory = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="m16 25.54-3.763 6.452C11.459 33.326 12.42 35 13.964 35h7.072c1.543 0 2.505-1.674 1.727-3.008L19 25.541V22h-3v3.54ZM21 20v5l3.491 5.985C26.047 33.65 24.123 37 21.036 37h-7.072c-3.087 0-5.01-3.349-3.455-6.015L14 25v-5h7ZM31.455 17.037C34.003 15.38 36 13.899 36 11h2c0 4.1-3.003 6.12-5.455 7.713l-.265.173c-1.18.765-2.22 1.44-3.005 2.237C28.472 21.94 28 22.826 28 24c0 1.174.472 2.06 1.275 2.877.785.797 1.825 1.472 3.005 2.237l.265.173C34.997 30.88 38 32.899 38 37h-2c0-2.9-1.997-4.38-4.545-6.037l-.304-.197c-1.13-.732-2.355-1.524-3.301-2.487C26.778 27.19 26 25.826 26 24s.778-3.19 1.85-4.28c.946-.962 2.17-1.754 3.301-2.486l.304-.197Z"
        fill="#333"
      />
      <Path
        fillRule="evenodd"
      ...
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M27 13a1 1 0 0 1 1-1h5a1 1 0 1 1 0 2h-5a1 1 0 0 1-1-1ZM30 35a1 1 0 0 1 1-1h5a1 1 0 1 1 0 2h-5a1 1 0 0 1-1-1ZM27 22a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2h-8a1 1 0 0 1-1-1ZM27 26a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2h-8a1 1 0 0 1-1-1Z"
        fill="#333"
      />
    </Svg>
  );
};
export default SvgBiochemistryLaboratory;
