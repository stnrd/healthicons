...
const SvgHivInd = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M34 18c1.111.009 2 .906 2 2 0 1.1-.898 2-2.016 2a1 1 0 0 0-1 1v3a1 1 0 1 0 2 0v-2.125A4.004 4.004 0 0 0 38 20a4.008 4.008 0 0 0-3.952-4h-.096C31.77 16.035 30 17.807 30 20a1 1 0 0 0 2 0c0-1.094.889-1.991 2-2ZM35 29a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" />
    </Svg>
  );
};
