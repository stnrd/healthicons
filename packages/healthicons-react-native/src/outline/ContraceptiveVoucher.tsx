...
const SvgContraceptiveVoucher = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="m21.346 25.674-1.918-1.919a2.957 2.957 0 0 0-.149 1.854l.68 2.953c.21.907-.827 1.583-1.573 1.025l-.485-.363c-2.184-1.634-5.239.258-4.749 2.94l.26 1.42 1.967-.36-.26-1.419c-.163-.894.856-1.525 1.584-.98l.485.363c2.238 1.675 5.349-.352 4.72-3.076l-.562-2.438Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
