...
const SvgTac = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M38.214 31.353A15.931 15.931 0 0 0 40 24c0-8.837-7.163-16-16-16S8 15.163 8 24c0 2.651.645 5.151 1.786 7.353L8.73 33.535A17.916 17.916 0 0 1 6 24c0-9.941 8.059-18 18-18s18 8.059 18 18c0 3.502-1 6.77-2.73 9.535l-1.056-2.182Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      />
      <Path d="M19.376 12.381a12 12 0 0 1 9.184.065l.779-1.842a14 14 0 0 0-10.715-.076l.752 1.853Z" />
    </Svg>
  );
};
