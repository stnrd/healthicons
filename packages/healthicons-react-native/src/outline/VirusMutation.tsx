...
const SvgVirusMutation = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="m12.293 27.707-3-3 1.414-1.414 3 3-1.414 1.414ZM18 21v4.09h-2V21h2ZM34 10.8a3.2 3.2 0 1 0 0 6.4 3.2 3.2 0 0 0 0-6.4ZM28.8 14a5.2 5.2 0 1 1 10.4 0 5.2 5.2 0 0 1-10.4 0ZM32.3 7a1 1 0 0 1 1-1h1.4a1 1 0 1 1 0 2h-1.4a1 1 0 0 1-1-1Z"
        fill="#333"
      />
      <Path
        fillRule="evenodd"
...
export default SvgVirusMutation;
