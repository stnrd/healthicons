...
const SvgOldWoman = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="m18.165 19.46-.172 1.173c-.165 1.125-.483 2.605-.865 4.186l-.312 1.293-1.155-.658a3.32 3.32 0 0 1-.731-.56c-.625-.639-.942-1.501-.934-2.384a3.462 3.462 0 0 1 .98-2.4c.333-.339.774-.466 1.06-.526.32-.067.658-.089.943-.096l1.186-.028Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      />
      <Path d="M17.801 43.874a1.5 1.5 0 0 1-1.3-1.486v-3.374c1.364.203 2.63.333 3.867.393l-.92 3.375a1.5 1.5 0 0 1-1.647 1.092ZM24.553 42.782 23.63 39.4a40.98 40.98 0 0 0 3.87-.4v3.388a1.5 1.5 0 0 1-2.948.394Z" />
    </Svg>
  );
};
