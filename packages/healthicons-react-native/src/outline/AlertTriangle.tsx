...
const SvgAlertTriangle = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M22 20a2 2 0 1 1 4 0v10a2 2 0 1 1-4 0V20ZM22 35.966C22 34.88 22.88 34 23.966 34h.068a1.966 1.966 0 1 1 0 3.933h-.067A1.966 1.966 0 0 1 22 35.966Z" />
    </Svg>
  );
};
