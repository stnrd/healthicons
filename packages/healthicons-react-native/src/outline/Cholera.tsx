...
const SvgCholera = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M27.03 33.517a1 1 0 0 1-1.012-.988A2.5 2.5 0 0 1 28.488 30a1 1 0 0 1 .024 2 .5.5 0 0 0-.494.506 1 1 0 0 1-.988 1.011ZM32 31a1 1 0 1 0 0 2 .5.5 0 0 1 .5.5 1 1 0 1 0 2 0A2.5 2.5 0 0 0 32 31ZM29.763 38.25a1 1 0 0 1-.762 1.192 2.5 2.5 0 0 1-2.978-1.906 1 1 0 0 1 1.954-.429.5.5 0 0 0 .595.381 1 1 0 0 1 1.191.763ZM33 39a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM31 28a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM30 36a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
