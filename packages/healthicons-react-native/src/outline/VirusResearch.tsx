...
const SvgVirusResearch = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10.98 10.98a1 1 0 0 1 1.413 0l2.829 2.828a1 1 0 0 1-1.414 1.414l-2.829-2.829a1 1 0 0 1 0-1.414ZM13.808 36.435a1 1 0 0 1-1.415 0l-2.828-2.828a1 1 0 0 1 1.414-1.414l2.829 2.828a1 1 0 0 1 0 1.414Z"
        fill="#333"
      />
      <Path
        fillRule="evenodd"
