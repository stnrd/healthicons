...
const SvgWaterTreatment = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M41.425 28.515A18 18 0 0 1 35.314 38H41v2h-9v-9h2v5.49A16 16 0 0 0 19.217 8.732l-.598-1.909a18 18 0 0 1 22.806 21.692ZM8.511 19.987A16 16 0 0 1 14 11.51V17h2V8H7v2h5.686a18 18 0 0 0 16.695 31.177l-.598-1.908A16 16 0 0 1 8.51 19.987Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
