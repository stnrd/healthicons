...
const SvgNegative4X4 = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        d="M19.892 8.39a1 1 0 0 0-1.224.707l-1.553 5.795 18.352 4.918 1.553-5.796a1 1 0 0 0-.707-1.225l-16.42-4.4Zm-4.624 15.325a1.5 1.5 0 1 0 .777-2.898 1.5 1.5 0 0 0-.777 2.898Zm19.224 3.598a1.5 1.5 0 1 1-2.898-.776 1.5 1.5 0 0 1 2.898.776Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgNegative4X4);
