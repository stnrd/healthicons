...
const SvgFilledTempleAlt = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        ...
        clipRule="evenodd"
      />
      <Path fill="#333" d="M24 6.048a5 5 0 0 0-5 5h10a5 5 0 0 0-5-5Z" />
      <Path
        fill="#333"
        fillRule="evenodd"
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M25 11h-2v19h2V11Zm-4-2v23h6V9h-6ZM9 40v-2h11v2H9Zm-1 2a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1h13a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H8Zm20-2v-2h11v2H28Zm-1 2a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1h13a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H27Z"
        clipRule="evenodd"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgFilledTempleAlt);
