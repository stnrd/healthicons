...
const SvgNegativeLetrina = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path fill="#333" d="M21 11h6l-6.518.033A4.03 4.03 0 0 1 21 11Z" />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgNegativeLetrina);
