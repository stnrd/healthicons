...
const SvgFilledVomitting = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        d="m18.976 32.101.005-.008a.046.046 0 0 1-.005.008Zm10.048 0-.005-.008.005.008Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
      ...
      <Path
        fill="#333"
        d="M15.241 20.349a1 1 0 0 1 1.314-.181l3 2a1 1 0 0 1 0 1.664l-3 2a1 1 0 0 1-1.267-1.534c.724-.734.825-1.08.824-1.26-.002-.202-.129-.574-.85-1.363a1 1 0 0 1-.02-1.326Zm16.204-.181a1 1 0 0 1 1.293 1.507c-.721.789-.848 1.161-.85 1.363-.001.18.1.526.824 1.26a1 1 0 0 1-1.267 1.534l-3-2a1 1 0 0 1 0-1.664l3-2Z"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgFilledVomitting);
