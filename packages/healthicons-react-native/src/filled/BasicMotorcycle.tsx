...
const SvgBasicMotorcycle = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M28.026 17.052a.094.094 0 0 0-.084-.052h-4.257c-3.142 0-5.447 2.952-4.685 6h10.382a1 1 0 0 0 .894-1.447l-2.25-4.501ZM7 18a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h9.42a1 1 0 0 0 .78-1.625l-1.199-1.498A5 5 0 0 0 12.097 18H7ZM34 16.5l6.067-2.5.933 6-6.067-1L34 16.5Z" />
    </Svg>
  );
};
