...
const SvgHepatology = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M22.073 15.027c.582-1.659 1.786-3.677 4.242-5.017l.957 1.756c-1.914 1.044-2.848 2.602-3.312 3.923a8.16 8.16 0 0 0-.396 1.69 6.483 6.483 0 0 0-.046.617v.028-.003l-1 .019-1 .019V18.03a3.829 3.829 0 0 1 .005-.244c.007-.159.023-.38.056-.651.066-.54.204-1.282.494-2.109Z"
        fill="#333"
      />
      <Path
