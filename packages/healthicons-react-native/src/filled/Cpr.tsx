...
const SvgCpr = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M16 12a4 4 0 1 1-8 0 4 4 0 0 1 8 0ZM19 23v8a2 2 0 1 1-4 0V19.271c0-3.43 4.033-5.268 6.623-3.02l9.764 8.48a7.589 7.589 0 0 1 2.537 6.803L33 38h7a2 2 0 1 1 0 4H30a2 2 0 0 1-2-2v-7.204a4 4 0 0 0-1.343-2.99L19 23Z" />
    </Svg>
  );
};
