...
const SvgHazardous = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="m20.3 30-4.216 7.44a.64.64 0 0 0-.059.495.662.662 0 0 0 .315.393c4.667 2.61 10.654 2.61 15.318 0a.661.661 0 0 0 .317-.393.638.638 0 0 0-.06-.495L27.701 30a6.046 6.046 0 0 1-3.7 1.25A6.046 6.046 0 0 1 20.3 30ZM20.85 17.724l-4.336-7.371a.64.64 0 0 0-.398-.299.662.662 0 0 0-.499.077c-4.593 2.736-7.587 7.92-7.659 13.265a.661.661 0 0 0 .183.471c.12.125.284.195.458.196l8.55.07a6.047 6.047 0 0 1 .769-3.829 6.046 6.046 0 0 1 2.932-2.58ZM30.85 24.275l8.551-.069a.64.64 0 0 0 .458-.196.662.662 0 0 0 .183-.47c-.073-5.346-3.066-10.53-7.659-13.265a.662.662 0 0 0-.498-.078.638.638 0 0 0-.4.299l-4.335 7.37a6.047 6.047 0 0 1 2.932 2.58c.7 1.211.938 2.559.768 3.83ZM29 24a5 5 0 1 1-10 0 5 5 0 0 1 10 0Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
