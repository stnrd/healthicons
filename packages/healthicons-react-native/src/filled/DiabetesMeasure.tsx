...
const SvgDiabetesMeasure = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M23.967 22.147c2.24-.002 3.999-1.68 3.997-3.813-.002-1.98-4.005-6.854-4.005-6.854s-3.997 4.727-3.995 6.86c.002 2.134 1.763 3.809 4.003 3.807ZM23.982 40.083a2 2 0 1 0-.003-4 2 2 0 0 0 .003 4Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
