...
const SvgCrisisResponseCenterPerson = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M28 30a4 4 0 1 1-8 0 4 4 0 0 1 8 0ZM24 35a21.45 21.45 0 0 0-4.612.56c-.764.185-1.521.432-2.111.762-.516.289-1.277.853-1.277 1.8V42h16v-3.879c0-.946-.761-1.51-1.277-1.8-.59-.329-1.347-.576-2.111-.761A21.45 21.45 0 0 0 24 35Z" />
    </Svg>
  );
};
