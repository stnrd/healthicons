...
const SvgMinerWorker = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M12 30.425a29.243 29.243 0 0 1 2-.717V42h-2V30.425ZM34 29.708c.687.22 1.357.459 2 .717V42h-2V29.708ZM10 31.345C7.635 32.597 6 34.167 6 36v6h4V31.345ZM42 36c0-1.833-1.635-3.404-4-4.655V42h4v-6Z" />
    </Svg>
  );
};
