  ...
  return (
    ...
    >
      ...
      <Path
        ...
        fill="#333"
      />
      <Path d="M13 36.5a2.5 2.5 0 1 1 5 0 2.5 2.5 0 0 1-5 0Z" fill="#333" />
      <Path
        d="M13.096 40.257c0-.963.769-1.744 1.717-1.744.949 0 1.717.78 1.717 1.744 0 .962-.768 1.743-1.717 1.743-.948 0-1.717-.78-1.717-1.743ZM16.101 29.796c-.858-1.308-2.146-9.153 3.434-8.718 5.581.436 1.288-.435 1.288-.435l-.429-3.052-3.864-1.307-4.293 3.051-.858 6.974s5.58 4.794 4.722 3.487Z"
        fill="#333"
      />
      <Path
        fillRule="evenodd"
