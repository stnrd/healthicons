...
const SvgMegaphone = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M12 31v7a2 2 0 1 0 4 0v-7h-4ZM7 26v-6a3 3 0 0 1 3-3h6v12h-6a3 3 0 0 1-3-3ZM34 23v-1a3 3 0 0 0-3-3v7a3 3 0 0 0 3-3ZM18 30V15l9.463-6.022A1 1 0 0 1 29 9.822v25.356a1 1 0 0 1-1.537.844L18 30Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
