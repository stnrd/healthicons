  ...
  return (
    ...
    >
      ...
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M40 10.537v23.431a.06.06 0 0 1-.029.018.058.058 0 0 1-.025 0c-5.732-1.046-10.014.215-14.923 2.437a.028.028 0 0 1-.008.002h-.001a.026.026 0 0 1-.011-.004L25 36.419V13.176c5.317-2.504 9.342-4.054 15-2.639Zm.516-1.932c-6.394-1.609-10.98.226-16.37 2.764A2 2 0 0 0 23 13.177V36.42c0 1.478 1.532 2.42 2.847 1.826 4.73-2.141 8.575-3.234 13.74-2.291C40.8 36.175 42 35.27 42 33.967V10.524c0-.885-.589-1.694-1.484-1.92ZM11.01 29.003c3.67-.038 5.717.332 9.612 1.923l.756-1.852c-4.127-1.685-6.438-2.112-10.388-2.071l.02 2ZM11.01 25.003c3.67-.038 5.717.332 9.612 1.923l.756-1.852c-4.127-1.685-6.438-2.112-10.388-2.071l.02 2ZM11.01 21.003c3.67-.038 5.717.332 9.612 1.923l.756-1.852c-4.127-1.685-6.438-2.112-10.388-2.071l.02 2ZM13.5 13v3h-2v-3h2ZM17 14v3h-2v-3h2ZM20.5 15v3h-2v-3h2Z"
        fill="#333"
      />
      <Path
        fillRule="evenodd"
