...
const SvgAsthmaInhaler = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M33 29h2v10h-2V29ZM38 33a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM39 36a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM42 35a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM43 30a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM42 39a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" />
    </Svg>
  );
};
