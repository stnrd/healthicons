  ...
  return (
    ...
    >
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8 25.898c.792.547 1.756.87 2.809.87a4.945 4.945 0 0 0 4.074-2.145 5.475 5.475 0 0 0 4.547 2.42 5.476 5.476 0 0 0 4.566-2.447 5.476 5.476 0 0 0 4.57 2.452c1.885 0 3.548-.952 4.535-2.402a4.943 4.943 0 0 0 4.05 2.098c1.07-.001 2.05-.338 2.849-.904V42H20V29h-8v13H8V25.898Zm28 5.15H26v6h10v-6Zm-12-2v10h14v-10H24Z"
        fill="#333"
      />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 29h8v13h20V25.84a4.901 4.901 0 0 1-2.85.904 4.926 4.926 0 0 1-2.576-.72 4.976 4.976 0 0 1-1.473-1.378 5.512 5.512 0 0 1-1.425 1.434 5.454 5.454 0 0 1-3.067.968h-.087a5.455 5.455 0 0 1-3.108-.995 5.513 5.513 0 0 1-1.418-1.457 5.512 5.512 0 0 1-1.42 1.455 5.45 5.45 0 0 1-3.146.992 5.45 5.45 0 0 1-3.125-.978 5.51 5.51 0 0 1-1.422-1.442 4.976 4.976 0 0 1-1.461 1.396 4.926 4.926 0 0 1-2.614.748A4.9 4.9 0 0 1 8 25.897v16.103h4V29Zm26 .048H24v10h14m-4-6h-6v2h6v-2Zm2-2v6H26v-6h10Zm-7.435-2H38h-9.435Z"
        fill="#333"
      />
      <Path
        fillRule="evenodd"
