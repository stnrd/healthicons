...
const SvgDiabetesSymbols = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M42.982 28.942c.002 1.6-1.317 2.858-2.997 2.86-1.68 0-3.002-1.255-3.003-2.855-.001-1.6 2.996-5.145 2.996-5.145s3.003 3.654 3.004 5.14Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
...
export default SvgDiabetesSymbols;
