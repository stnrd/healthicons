...
const SvgHivInd = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M36 19a2.008 2.008 0 0 0-2-2c-1.111.009-2 .906-2 2a1 1 0 1 1-2 0 4.008 4.008 0 0 1 3.984-4h.064C36.23 15.035 38 16.808 38 19a4.004 4.004 0 0 1-3.016 3.875V25a1 1 0 1 1-2 0v-3a1 1 0 0 1 1-1C35.102 21 36 20.1 36 19ZM21.456 35.932l-4.889-6.204-5.73 7.332a2 2 0 0 0 .368 2.826l4.379 3.317a2 2 0 0 0 2.781-.36l4.256-5.426-1.16-1.48-.005-.005ZM35 28a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" />
    </Svg>
  );
};
