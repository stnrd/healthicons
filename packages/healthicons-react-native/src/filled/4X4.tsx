...
const Svg4X4 = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M15 39c0-1.061-.474-2.078-1.318-2.829C12.838 35.421 11.693 35 10.5 35c-1.193 0-2.338.421-3.182 1.171C6.474 36.921 6 37.94 6 39v2a1 1 0 0 0 1 1h27.5a1 1 0 1 0 0-2H25a2 2 0 0 0-4 0 3 3 0 0 0-6 0v-1ZM17.645 28.945l-5.796-1.553-.76 2.836a1 1 0 0 0 .707 1.225l3.864 1.035a1 1 0 0 0 1.225-.707l.76-2.836ZM28.445 31.886l5.796 1.553-.748 2.792a1 1 0 0 1-1.225.707l-3.864-1.035a1 1 0 0 1-.707-1.225l.748-2.792ZM20.063 27.07l1.036-3.864 2.516.675-1.128 3.839-2.424-.65ZM24.42 28.237l1.127-3.839 2.313.62-1.035 3.864-2.405-.645Z"
        fill="#333"
      />
    </Svg>
  );
