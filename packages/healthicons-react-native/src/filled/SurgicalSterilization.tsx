...
const SvgSurgicalSterilization = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <Path d="M15 15V4s-3.478 2.26-3.948 10.998C10.993 16.101 11.895 17 13 17a2 2 0 0 0 2-2ZM12 20.5a1.5 1.5 0 0 1 3 0v.086l-3 3V20.5ZM12 26.414v1.672l3-3v-1.672l-3 3ZM12 32.586v-1.672l3-3v1.672l-3 3ZM12 35.414V42.5a1.5 1.5 0 0 0 3 0V32.414l-3 3Z" />
    </Svg>
  );
};
