...
const SvgFilledForestPersons = (
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path fill="#333" d="M15 21a1 1 0 1 1 2 0v18a1 1 0 1 1-2 0V21Z" />
      <Path
        fill="#333"
...
const ForwardRef = forwardRef(SvgFilledForestPersons);
