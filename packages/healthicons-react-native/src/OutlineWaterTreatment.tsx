...
const SvgOutlineWaterTreatment = (
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M14.86 10.867A16 16 0 0 0 28.784 39.27l.598 1.908A18 18 0 0 1 13.718 9.225l1.143 1.642Zm18.28 26.266A16 16 0 0 0 19.216 8.732l-.598-1.909a18 18 0 0 1 15.663 31.952l-1.143-1.642Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M14 10H7V8h9v9h-2v-7Zm20 28h7v2h-9v-9h2v7Z"
        clipRule="evenodd"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgOutlineWaterTreatment);
