...
const SvgOutlineNurse = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path fill="#333" d="M27 13v-2h-2V9h-2v2h-2v2h2v2h2v-2h2Z" />
      <Path
        fill="#333"
        fillRule="evenodd"
        ...
        clipRule="evenodd"
      />
      <Path fill="#333" d="M34 34h2v2h-2v2h-2v-2h-2v-2h2v-2h2v2Z" />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgOutlineNurse);
