...
const SvgFilledLactation = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        ...
        clipRule="evenodd"
      />
      <Path fill="#333" d="M31 11a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgFilledLactation);
