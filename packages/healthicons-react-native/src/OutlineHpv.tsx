...
const SvgOutlineHpv = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        d="M31 28a1 1 0 0 0 .923-.615l2.5-6a1 1 0 0 0-1.846-.77L31 24.4l-1.577-3.785a1 1 0 0 0-1.846.77l2.5 6A1 1 0 0 0 31 28Zm-15-7a1 1 0 1 0-2 0v6a1 1 0 1 0 2 0v-2h2v2a1 1 0 1 0 2 0v-6a1 1 0 1 0-2 0v2h-2v-2Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgOutlineHpv);
