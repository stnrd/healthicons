  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M25 34c.552 0 1-1.12 1-2.5s-.448-2.5-1-2.5-1 1.12-1 2.5.448 2.5 1 2.5Zm-1 1a1 1 0 0 1 1 1v4.5a1 1 0 1 1-2 0V36a1 1 0 0 1 1-1Z"
        clipRule="evenodd"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgOutlineEndocrinology);
