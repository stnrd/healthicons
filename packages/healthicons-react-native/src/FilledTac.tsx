...
const SvgFilledTac = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path fill="#333" d="M24 25a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledTac);
