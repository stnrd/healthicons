...
const SvgFilledOfficer = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M13.5 10.097C13.5 7.774 24 6 24 6s10.5 1.774 10.5 4.097c0 3.097-1.91 4.403-1.91 4.403H15.41s-1.91-1.306-1.91-4.403Zm12.5-.53s-1.467-.534-2-1.067c-.533.533-2 1.067-2 1.067s.4 2.933 2 2.933 2-2.933 2-2.933Zm5.814 8.713c1.39-1.085 1.174-2.28 1.174-2.28H15.012s-.217 1.195 1.174 2.28a8 8 0 1 0 15.629 0ZM24 20c2.721 0 4.623-.314 5.952-.766a6 6 0 1 1-11.903 0c1.328.452 3.23.766 5.951.766Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
...
const ForwardRef = forwardRef(SvgFilledOfficer);
