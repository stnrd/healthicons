...
const SvgFilledReferral = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path fill="#333" d="M37 27a3 3 0 1 1-6 0 3 3 0 1 1 6 0Z" />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledReferral);
