...
const SvgNegativeFemaleReproductiveSystem = (
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#negative_female_reproductive_system_svg__a)">
        <Path
          fill="#333"
          fillRule="evenodd"
      ...
      <Defs>
        <ClipPath id="negative_female_reproductive_system_svg__a">
...
const ForwardRef = forwardRef(SvgNegativeFemaleReproductiveSystem);
