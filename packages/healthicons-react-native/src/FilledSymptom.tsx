...
const SvgFilledSymptom = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        d="M35.084 38.183A17.966 17.966 0 0 0 42 24c0-7.857-5.034-14.538-12.052-16.994l.66-1.888C38.408 7.847 44 15.27 44 24c0 6.413-3.018 12.121-7.712 15.781l-1.204-1.598Zm-6.618 3.259A18.033 18.033 0 0 1 24 42a18.04 18.04 0 0 1-4.372-.535l-.475 1.943c1.552.387 3.175.592 4.847.592 1.706 0 3.361-.214 4.942-.615l-.476-1.943ZM6 24c0 5.789 2.733 10.94 6.979 14.232l-1.204 1.598C7.045 36.172 4 30.442 4 24 4 15.27 9.593 7.847 17.391 5.118l.661 1.888C11.034 9.462 6 16.143 6 24ZM28.5 8.5A4.5 4.5 0 1 1 23.99 4h.02a4.5 4.5 0 0 1 4.49 4.5Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledSymptom);
