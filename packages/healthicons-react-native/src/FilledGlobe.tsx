...
const SvgFilledGlobe = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="m35.25 39-1.195-6.78h-1.278a1.75 1.75 0 0 1-.779-.184 1.781 1.781 0 0 1-.62-.51 1.82 1.82 0 0 1-.326-1.55l.889-3.613c.097-.39.32-.737.632-.983a1.76 1.76 0 0 1 1.093-.38H41.5c1.404 5.204-.134 8.282-6.25 14Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
