...
const SvgNegativeJustice = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        d="m37.696 17-3.236-5.177L30.901 17h6.795Zm-19.893 6.218-3.839-5.933-4.188 5.933h8.027Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgNegativeJustice);
