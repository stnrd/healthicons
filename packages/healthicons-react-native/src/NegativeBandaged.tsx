...
const SvgNegativeBandaged = (
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="M9.975 16.293c2.652-4.816 7.713-8.12 13.56-8.286l-13.56 8.286ZM7.592 27.589l26.702-16.574c-.474-.407-1.145-.876-1.96-1.333-1.16-.65-2.434-1.177-3.526-1.429-.545-.125-.983-.168-1.305-.154-.275.012-.383.061-.397.067l-.001.001-.028.019L9.054 19.2c-.404.256-.89.899-1.258 2.103-.355 1.16-.512 2.566-.484 3.905.02.954.131 1.774.28 2.38Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgNegativeBandaged);
