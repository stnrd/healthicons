...
const SvgOutlineCleaning = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="M16.36 35.231a1 1 0 0 1 1.28 1.537l-.001.001-.002.002-.003.002-.01.008-.03.025-.103.079c-.087.065-.21.154-.367.26-.315.21-.77.484-1.344.758A11.149 11.149 0 0 1 11 39a1 1 0 1 1 0-2 9.15 9.15 0 0 0 3.92-.903 8.836 8.836 0 0 0 1.094-.617 5.93 5.93 0 0 0 .337-.24l.01-.01v.001Zm3.195 6.601a1 1 0 0 0-1.11-1.664l-.002.002-.02.012-.086.055a14.28 14.28 0 0 1-1.618.85c-1.07.474-2.42.913-3.719.913a1 1 0 1 0 0 2c1.702 0 3.35-.561 4.531-1.086a16.244 16.244 0 0 0 1.863-.979 8.43 8.43 0 0 0 .114-.072l.032-.021.01-.006.005-.004Z"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgOutlineCleaning);
