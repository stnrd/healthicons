...
const SvgFilledUiZoomOut = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M33 22H21v-2h12v2Zm-14.621 9.207-7.086 7.086-1.414-1.414 7.086-7.086 1.414 1.414Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
...
const ForwardRef = forwardRef(SvgFilledUiZoomOut);
