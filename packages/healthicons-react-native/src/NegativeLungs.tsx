...
const SvgNegativeLungs = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#negative_lungs_svg__a)">
        <Path
          fill="#333"
          fillRule="evenodd"
      ...
      <Defs>
        <ClipPath id="negative_lungs_svg__a">
...
const ForwardRef = forwardRef(SvgNegativeLungs);
