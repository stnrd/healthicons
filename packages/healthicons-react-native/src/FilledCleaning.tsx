...
const SvgFilledCleaning = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="M17.768 35.36a1 1 0 0 0-1.408-.129h.002l-.011.008-.063.048a5.93 5.93 0 0 1-.274.194c-.248.165-.618.39-1.094.616A9.15 9.15 0 0 1 11 37a1 1 0 1 0 0 2 11.15 11.15 0 0 0 4.78-1.097 10.83 10.83 0 0 0 1.344-.758 7.915 7.915 0 0 0 .47-.34l.03-.023.01-.008.003-.004h.002l.001-.002a1 1 0 0 0 .128-1.408Zm2.064 5.085a1 1 0 0 1-.277 1.387l-.002.002-.004.002-.01.006-.031.02a13.039 13.039 0 0 1-.527.318c-.351.201-.85.468-1.45.734C16.351 43.439 14.701 44 13 44a1 1 0 1 1 0-2c1.298 0 2.65-.439 3.719-.914a14.28 14.28 0 0 0 1.618-.85 1.8 1.8 0 0 0 .086-.054l.02-.012.002-.002a1 1 0 0 1 1.387.277Z"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgFilledCleaning);
