...
const SvgOutlineAgricultureWorker = (
  ...
  return (
    ...
    >
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M31.414 12.714 30 8c0-1.105-2.988-2-6-2s-6 .895-6 2l-1.414 4.714C13.21 13.436 11 14.639 11 16c0 2.21 5.82 4 13 4s13-1.79 13-4c0-1.361-2.21-2.564-5.586-3.286Zm-3.282-3.98a4.267 4.267 0 0 0-.616-.245C26.623 8.202 25.335 8 24 8s-2.623.202-3.516.49c-.282.09-.483.176-.616.244l-.731 2.437a36.3 36.3 0 0 0 9.726 0l-.73-2.437Zm1.312 4.374a31.73 31.73 0 0 1-1.015.135 38.3 38.3 0 0 1-8.858 0 31.32 31.32 0 0 1-1.015-.135l-.395 1.314-1.157.248c-1.584.338-2.756.764-3.48 1.18a4.306 4.306 0 0 0-.24.15c.42.283 1.113.61 2.112.917C17.51 17.567 20.552 18 24 18c3.448 0 6.49-.433 8.604-1.083.999-.307 1.692-.634 2.112-.918a4.306 4.306 0 0 0-.24-.148c-.724-.417-1.896-.843-3.48-1.181l-1.157-.248-.395-1.314Zm5.619 3.185-.007-.011.007.011Zm-.003-.579a.066.066 0 0 1 .011-.016s-.002.006-.01.016Zm-22.131-.016s.005.005.01.016a.06.06 0 0 1-.01-.016Zm.008.595.007-.011-.002.004a.033.033 0 0 0-.005.007Zm6.742-7.445a.08.08 0 0 0-.012.01l.016-.014-.004.004Zm8.638-.004.017.014a.065.065 0 0 1-.017-.014Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
...
const ForwardRef = forwardRef(SvgOutlineAgricultureWorker);
