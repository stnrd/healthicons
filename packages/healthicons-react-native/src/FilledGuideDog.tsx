...
const SvgFilledGuideDog = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="M15 38a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1Zm21 0a1 1 0 0 1 1-1h2a1 1 0 1 1 0 2h-2a1 1 0 0 1-1-1ZM17.974 12.311c1.18.724 1.509 4.402 1.026 5.189-.483.787-1.595-1.616-2.775-2.34-1.18-.724-1.745-1.949-1.262-2.736.483-.786 1.83-.837 3.01-.113Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgFilledGuideDog);
