...
const SvgOutlineCalm = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="M13.743 24.35c-.12.738.381 1.445 1.064 1.883.714.457 1.731.707 2.93.53a3.794 3.794 0 0 0 2.653-1.665c.505-.764.712-1.693.48-2.382a.5.5 0 0 0-.818-.203c-1.795 1.704-3.823 2.123-5.642 1.448a.5.5 0 0 0-.667.39Zm20.076 0c.119.738-.382 1.445-1.065 1.883-.714.457-1.731.707-2.93.53a3.795 3.795 0 0 1-2.653-1.665c-.505-.764-.712-1.693-.48-2.382a.5.5 0 0 1 .818-.203c1.796 1.704 3.824 2.123 5.642 1.448a.5.5 0 0 1 .667.39Z"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgOutlineCalm);
