...
const SvgRdtResultPfRectangular = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#rdt-result-pf-rectangular_svg__a)">
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <Defs>
        <ClipPath id="rdt-result-pf-rectangular_svg__a">
...
export default SvgRdtResultPfRectangular;
