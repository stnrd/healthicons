...
const SvgBabyMale0203MAlt = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#baby-male-0203m-alt_svg__a)">
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <Defs>
        <ClipPath id="baby-male-0203m-alt_svg__a">
...
export default SvgBabyMale0203MAlt;
