...
const SvgRdtResultInvalid = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#rdt-result-invalid_svg__a)" fill="#000">
      ...
      <Defs>
        <ClipPath id="rdt-result-invalid_svg__a">
...
export default SvgRdtResultInvalid;
