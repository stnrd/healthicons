...
const SvgRdtResultMixed = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#rdt-result-mixed_svg__a)" fill="#000">
      ...
      <Defs>
        <ClipPath id="rdt-result-mixed_svg__a">
...
export default SvgRdtResultMixed;
