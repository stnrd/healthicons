...
const SvgRdtResultMixedRectangular = (passedProps: SvgProps) => {
  ...
  return (
    ...
    >
      <Path
        d="M38 22a2 2 0 1 1 0 4 2 2 0 0 1 0-4ZM31 24a1.5 1.5 0 1 0 3 0 1.5 1.5 0 0 0-3 0Z"
        fill="#333"
      />
      <Path
        fillRule="evenodd"
...
export default SvgRdtResultMixedRectangular;
