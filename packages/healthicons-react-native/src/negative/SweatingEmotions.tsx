...
const SvgSweatingEmotions = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#sweating_emotions_svg__a)">
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <Defs>
        <ClipPath id="sweating_emotions_svg__a">
...
export default SvgSweatingEmotions;
