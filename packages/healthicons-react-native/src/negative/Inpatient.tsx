...
const SvgInpatient = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="m16.117 17.188.364-.364a1.77 1.77 0 0 0 0-2.504l-1.8-1.8a1.771 1.771 0 0 0-2.504-.002l-.35.35 4.29 4.32ZM38 27v3H9v-8.644l5.275 5.311c.212.213.498.333.797.333H38Z" />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
