...
const SvgSocialDistancingAlt = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#social-distancing-alt_svg__a)">
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <Defs>
        <ClipPath id="social-distancing-alt_svg__a">
...
export default SvgSocialDistancingAlt;
