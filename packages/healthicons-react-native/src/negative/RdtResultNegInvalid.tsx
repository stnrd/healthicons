...
const SvgRdtResultNegInvalid = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#rdt-result-neg-invalid_svg__a)" fill="#000">
      ...
      <Defs>
        <ClipPath id="rdt-result-neg-invalid_svg__a">
...
export default SvgRdtResultNegInvalid;
