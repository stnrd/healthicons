...
const SvgRdtResultNegRectangular = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#rdt-result-neg-rectangular_svg__a)">
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <Defs>
        <ClipPath id="rdt-result-neg-rectangular_svg__a">
...
export default SvgRdtResultNegRectangular;
