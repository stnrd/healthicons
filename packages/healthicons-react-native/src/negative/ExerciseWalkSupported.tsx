...
const SvgExerciseWalkSupported = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#exercise_walk_supported_svg__a)">
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <Defs>
        <ClipPath id="exercise_walk_supported_svg__a">
...
export default SvgExerciseWalkSupported;
