...
const SvgGroupDiscussionMeetingx3 = (passedProps: SvgProps) => {
  ...
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#group-discussion-meetingx3_svg__a)">
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <Defs>
        <ClipPath id="group-discussion-meetingx3_svg__a">
...
export default SvgGroupDiscussionMeetingx3;
