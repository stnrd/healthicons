...
const SvgOutlineExerciseWalkSupported = (
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M18.557 30.9a1 1 0 0 0-1.651.437l-.983 3.318-1.918 2.889a3 3 0 0 0 4.999 3.318l2.167-3.264a3 3 0 0 0 .377-.807l.524-1.77a1 1 0 0 0-.266-1.005L18.557 30.9Zm-.76 4.467.56-1.888 1.625 1.558-.352 1.186a.998.998 0 0 1-.125.269l-2.167 3.264a1 1 0 0 1-1.667-1.106l2.001-3.014a.993.993 0 0 0 .126-.27Z"
        clipRule="evenodd"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgOutlineExerciseWalkSupported);
