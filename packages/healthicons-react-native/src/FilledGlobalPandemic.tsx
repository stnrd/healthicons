  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M15.149 19a3.554 3.554 0 0 1 2.195.754 3.581 3.581 0 0 1 1.267 1.948v.003l1.284 5.163a3.598 3.598 0 0 1-.65 3.067 3.569 3.569 0 0 1-2.812 1.378h-1.024l-1.567 7.882a1 1 0 1 1-1.961-.39l1.726-8.687a1 1 0 0 1 .98-.805h1.846a1.555 1.555 0 0 0 1.233-.605 1.588 1.588 0 0 0 .287-1.36l-1.282-5.157v-.002a1.582 1.582 0 0 0-.559-.859 1.554 1.554 0 0 0-.96-.33H6a1 1 0 1 1 0-2h9.149Zm14.254-7.233a3.3 3.3 0 0 1 2.11-.767H38a1 1 0 1 1 0 2h-6.489c-.293 0-.586.103-.831.307a1.56 1.56 0 0 0-.514.845l-1.192 5.077a1 1 0 1 1-1.948-.458l1.193-5.077a3.563 3.563 0 0 1 1.184-1.927Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M31 27.6a4.4 4.4 0 1 0 0 8.8 4.4 4.4 0 0 0 0-8.8ZM24.6 32a6.4 6.4 0 1 1 12.8 0 6.4 6.4 0 0 1-12.8 0Zm4.5-9a1 1 0 0 1 1-1h1.8a1 1 0 1 1 0 2h-1.8a1 1 0 0 1-1-1Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M30 27.5v-3.6h2v3.6h-2Zm5.693-3.407a1 1 0 0 1 1.414 0l1.8 1.8a1 1 0 0 1-1.414 1.414l-1.8-1.8a1 1 0 0 1 0-1.414Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M35.4 32a1 1 0 0 1 1-1H40a1 1 0 1 1 0 2h-3.6a1 1 0 0 1-1-1Zm4.407 4.693a1 1 0 0 1 0 1.414l-1.8 1.8a1 1 0 0 1-1.414-1.414l1.8-1.8a1 1 0 0 1 1.414 0Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M31 36.4a1 1 0 0 1 1 1V41a1 1 0 1 1-2 0v-3.6a1 1 0 0 1 1-1Zm-7.907.293a1 1 0 0 1 1.414 0l1.8 1.8a1 1 0 0 1-1.414 1.414l-1.8-1.8a1 1 0 0 1 0-1.414Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
      ...
      <Path
        fill="#333"
        fillRule="evenodd"
        d="M21 32a1 1 0 0 1 1-1h3.6a1 1 0 1 1 0 2H22a1 1 0 0 1-1-1Zm5.307-7.907a1 1 0 0 1 0 1.414l-1.8 1.8a1 1 0 0 1-1.414-1.414l1.8-1.8a1 1 0 0 1 1.414 0Z"
        clipRule="evenodd"
      />
      <Path
        fill="#333"
...
const ForwardRef = forwardRef(SvgFilledGlobalPandemic);
