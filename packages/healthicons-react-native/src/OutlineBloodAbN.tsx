...
const SvgOutlineBloodAbN = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        ...
        clipRule="evenodd"
      />
      <Path fill="#333" d="M34 18a1 1 0 1 0 0 2h3a1 1 0 0 0 0-2h-3Z" />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgOutlineBloodAbN);
