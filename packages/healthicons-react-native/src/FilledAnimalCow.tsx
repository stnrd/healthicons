...
const SvgFilledAnimalCow = (passedProps: SvgProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <Path
        fill="#333"
        d="m28.074 29.768-1.748.715.758 1.851 1.747-.714-.757-1.852Zm.802 4.09 1.059-1.97 1.762.948-1.059 1.97-1.762-.948Zm4.134-.94.424 2.196 1.964-.38-.425-2.196-1.964.38Z"
      />
    </Svg>
  );
};
const ForwardRef = forwardRef(SvgFilledAnimalCow);
