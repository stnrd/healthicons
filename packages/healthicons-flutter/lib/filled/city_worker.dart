...
class CityWorker extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const CityWorker({Key? key, this.color, this.width, this.height})
      : super(key: key);
