...
<path fill-rule="evenodd" clip-rule="evenodd" d="M28 9H16V12C16 12.5523 15.5523 13 15 13C14.4477 13 14 12.5523 14 12V9H9C7.89543 9 7 9.89543 7 11V16C7 17.1046 7.89543 18 9 18H33C34.1046 18 35 17.1039 35 15.9993V11.0006C35 9.89608 34.1046 9 33 9H30V12C30 12.5523 29.5523 13 29 13C28.4477 13 28 12.5523 28 12V9Z" fill="#333333"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M36 18H8V16H36V18Z" fill="#333333"/>
<path d="M12 7C12 6.44772 12.4477 6 13 6C13.5523 6 14 6.44772 14 7V11C14 11.5523 13.5523 12 13 12C12.4477 12 12 11.5523 12 11V7Z" fill="#333333"/>
<path d="M26 7C26 6.44772 26.4477 6 27 6C27.5523 6 28 6.44772 28 7V11C28 11.5523 27.5523 12 27 12C26.4477 12 26 11.5523 26 11V7Z" fill="#333333"/>
</svg>
''',
        color: color,
        width: width,
